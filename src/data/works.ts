...
const caseStudyBase: WorkCaseStudy[] = [
  {
    ...
    shortDescription:
      "A B2B fintech website for NAKA, focused on explaining stablecoin-native payment infrastructure and guiding partners toward the right solution.",
  ...
  },
  {
    ...
    title: "Tandem",
    heroOutcomeTitle:
      "Premium real estate website built around trust, long-term value, and investor confidence",
    frameworkSections: [
      {
        id: "problems",
        title: "Problems",
        paragraphs: [
          "The website needed to explain a complex business model.",
          "Partners and investors needed to quickly understand why Tandem feels trustworthy, experienced, and different from typical developers.",
          "The brand needed a digital presence that matched the scale, discipline, and emotional weight of its real estate portfolio.",
        ],
        media: [
          {
            type: "video",
            url: "/assets/tandem/tandem-1.mp4",
          },
        ],
      },
      {
        ...
        title: "Insight",
        paragraphs: [
          "The website needed to sell trust first, and projects second.",
          "Tandem’s strongest story is not only what they build, but how they work: long-term thinking, transparency, co-investment, and all-in ownership.",
          "The portfolio needed to work as proof of discipline and experience, not just a gallery of buildings.",
        ],
        media: [
          {
            type: "video",
            url: "/assets/tandem/tandem-2.mp4",
          },
        ],
      },
      {
        ...
        title: "Decision",
        paragraphs: [
          "I structured the website around a clear brand story: who Tandem is, how they work, what they build, and why partners trust them.",
          "The homepage was built to present Tandem as a long-term real estate partner, not just a developer.",
          "The service structure was separated into clear directions: Development, Construction & Design, and Property Management.",
          "The portfolio was built as a trust layer, showing projects through scale, execution, capital strategy, and outcomes.",
          "Scroll animations, transitions, image sequencing, and motion details were used to make the experience feel premium and memorable.",
        ],
        media: [
          {
            type: "video",
            url: "/assets/tandem/tandem-3.mp4",
          },
        ],
      },
      {
        ...
        title: "After",
        paragraphs: [
          "The website became a more modern, cinematic, and confidence-building experience for partners and investors.",
          "Users can understand Tandem’s business model, values, portfolio, and contact path without digging through a traditional corporate site.",
          "The final experience connects brand story, services, portfolio, team credibility, and enquiries into one polished digital platform.",
        ],
        media: [
          {
            type: "video",
            url: "/assets/tandem/tandem-4.mp4",
          },
        ],
      },
      // {
      ...
      //   title: "Business value",
      //   paragraphs: [
      //     "A clearer brand story helps investors and partners understand Tandem faster.",
      //     "Premium motion and visual direction make the company feel more established and memorable.",
      //     "Service pillars make the business model easier to understand and sell.",
      //     "Portfolio storytelling turns completed projects into proof of capability and execution.",
      //     "A stronger contact flow helps turn interest into qualified partner and investor conversations.",
      //   ],
      // },
    ],
    shortDescription:
      "A premium real estate website for Tandem, portfolio storytelling, long-term value, and investor confidence.",
    category: "Corporate Website / Real Estate",
    year: "2026",
    clientName: "Tandem",
    heroImage: "/assets/tandem/tandem-hero.png",
    role: ["UX/UI Design", "Web design", "Web development", "Motion design"],
    externalProjectLink: "https://www.thetandemco.com/",
  },
  {
    slug: "happly",
    title: "Happly",
  ...
  },
  {
    ...
    shortDescription:
      "HealthTech website redesign focused on performance, resource architecture, navigation clarity, and conversation.",
  ...
  },
  {
    ...
    shortDescription:
      "A corporate website for BBR Group Australia, focused on clear service communication, a stronger portfolio, and a direct path to enquiry.",
